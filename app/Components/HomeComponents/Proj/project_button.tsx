...
export default function ProjectButton(props: { link: string }) {
    ...
    return (
        <a
            className="text-3xl p-2 no-underline text-myblack dark:text-mywhite bg-[#f0f0f0] dark:bg-[#333333] rounded-full inline-flex max-w-12 hover:max-w-56 hover:scale-105 transition-all transition-configuration flex-row items-center justify-center"
