    ...
    return (
        <section className="text-center w-full md:w-[75%] lg:w-[60%] text-sm md:text-xl leading-loose mt-0">
            <p className="appear-animated mb-4">
                I am pursuing a <em>CS Honours + DS Minor</em> at UBC. I am passionate about
                research in HCI and love being an active member of my community. My SWDev
                experiences have taught me a lot about user-centric design, teamwork, and agile
                practices.
            </p>
