...
export default function Description() {
    return (
        <Container className="w-100 text-center">
            ...
            <p className="lead">
                My research in HCI focuses on comparing unencumbered interaction techniques in head-mounted displays (HMDs). I am also exploring the principles of In-Vehicle Infotainment Systems.
            </p>
        </Container>
    );
}